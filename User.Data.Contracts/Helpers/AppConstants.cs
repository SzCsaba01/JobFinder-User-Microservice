...
{
    public const string FE_APP_VERIFY_EMAIL_URL = "http://localhost:4200/verify-email";
    public const string FE_APP_CHANGE_PASSWORD_URL = "http://localhost:4200/change-password";
    ...
    public const string MICROSERVICE_URL = "http://localhost:5278";
