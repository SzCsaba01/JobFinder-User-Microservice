    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Skills", x => x.Skill);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProfileSkillMappings", x => new { x.UserProfileId, x.SkillName });
                    table.ForeignKey(
                        name: "FK_UserProfileSkillMappings_Skills_SkillName",
                        column: x => x.SkillName,
                        principalTable: "Skills",
                        principalColumn: "Skill",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProfileSkillMappings_UserProfiles_UserProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProfileSkillMappings_SkillName",
